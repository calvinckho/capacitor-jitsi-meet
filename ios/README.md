...
capacitor-jitsi-meet 1.3.9 uses iOS SDK 2.7.0, hence the last version that works with Xcode 1.3.1.
...
capacitor-jitsi-meet 1.4.0+ provides support for Xcode 1.4.1+.
